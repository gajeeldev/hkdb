  ...
  return (
    <LayoutDetailScreen
      ...
      <Text style={{ color: colors.textColor }}>
        The flowers originate from outside of Hallownest from a place known as "lands serene". They
        were brought to the kingdom by the great knight Ze'mer, who is now the Grey Mourner. The
        delicate flowers are rare, sacred objects which have a pure aura. They glow faintly with
        pale light.
      </Text>

      <Text style={{ color: colors.textColor, marginTop: 10 }}>
        There is a rare power hidden in their fragile petals. When a flower comes in contact with
        Void, it causes both the bug holding the flower and the Void to disappear. The flower
        remains behind, only slightly tinged by Void. Godmaster content Godseeker wonders if the
        flowers are splinters of something greater, but is unable to figure out whether this is
        true, as she cannot detect a resonance from it.
      </Text>
