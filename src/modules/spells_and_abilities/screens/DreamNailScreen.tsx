...
import { DreamBoss, EssenceRewards, RegularEnemies, WarriorDream } from '../data/data';
      ...
      <ScrollView
        ...
        <View style={styles.imageContainer}>
          <Image
            ...
            contentFit="contain"
            style={{ width: width, height: height * 0.25, marginHorizontal: 7, marginBottom: 10 }}
            placeholder={blurhash}
            transition={1000}
          />
        </View>
        ...
        <View style={{ flexDirection: 'row' }}>
          ...
          <View style={{ width: width * 0.8 }}>
            ...
            <Text style={styles.text}>Warping using the Dreamgate uses 1 Essence per warp.</Text>
          </View>
        </View>

        <Subtitle text="Essence Sources" />
        <Text style={{ color: colors.textColor }}>Using Dream Nail on a Spirit (26 total)</Text>
        <Text style={{ color: colors.textColor }}>
        ...
        <FlatList
          ...
          scrollEnabled={false}
        />
        <Text style={styles.text}>Regular enemies have a chance to drop Essence:</Text>
        <FlatList
          style={styles.list}
          data={RegularEnemies}
          renderItem={({ item }) => <Text style={{ color: colors.textColor }}>• {item}</Text>}
